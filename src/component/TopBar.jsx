...
export default function TopBar() {
    ...
    return (
        <div className="">
            ...
            <ul className={navbar ? " absolute right-0  bg-white  flex flex-col justify-center items-center h w-full opacity-95   transition-all ease-in delay-500 space-x-2  "
                                  : "absolute -right-full bg-white  flex flex-col justify-center items-center h w-full   transition-all ease-out delay-500 space-x-2  "}>
