    ...
    return (
        <section>
            ...
            <img onClick={toggleNavbar} className={navbar ? " w-6 mr-6 mt-8   cursor-pointer" : "hidden"} src={close} alt="" />
                ...
                <ul className={navbar ? "flex mb-10 pb-4 p-2 mr-6  space-y-5 text-right  rounded-xl  xl:flex flex-col justify-center   " : " xl:flex flex-row-reverse m-10 justify-center items-center w-full  space-x-2"}>

                    <li className=" w-auto flex justify-center  items-center   xl:justify-between text-blue-500  " >
                        <span className=" xl:mx-10 ">
                            صفحه اصلی
                        </span>
                        <img className={navbar ?" absolute ml-28  ": " absolute ml-16 mt-10 "} src={dot} alt="active" />
                    </li>
                    <li className="  w-auto">
